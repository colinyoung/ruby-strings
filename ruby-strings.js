...
String.prototype.to_s = function(alt) {
  ...
  var m = null; var regex = /#\{([^}]*)\}/gi; var cpy = this+"";
  while((m = regex.exec(this)) != null) {
    var value = "";
    try { value = eval(m[1]); } catch (e) {}
    if (typeof value == "number") value = value+"";
    if (typeof value == "boolean") value = value ? "true" : "false";    
    if (typeof value == "object") try {value = value.to_s(alt)} catch (e) {};
...
Boolean.prototype.to_s = function() { return this ? "false" : "true"; }